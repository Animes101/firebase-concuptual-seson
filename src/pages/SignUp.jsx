...
const SignUp = () => {
  ...
  return (
    ...
    <h1 className="text-3xl font-bold text-center text-indigo-600">SignUp</h1>
    ...
    <form onSubmit={handleSignUp} action="" className="space-y-6">
        <div className="space-y-2 text-sm">
            ...
            <input type="email" name="email" id="username" placeholder="enter your email" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring  " />
        </div>
        <div className="space-y-2 text-sm">
    ...
    <div className="flex items-center pt-4 space-x-2">
        ...
        <p className="text-sm text-gray-600">Sign Up with social accounts</p>
        <div className="flex-1 h-px bg-gray-300"></div>
    </div>
    {/* Social icons */}
